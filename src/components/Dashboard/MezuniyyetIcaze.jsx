...
const EmpMezuniyyet = props => {
	...
	return (
		<Card withBorder p="xl" radius="md" className={classes.card} display="flex">
			<div className={classes.inner}>
				...
				<Box sx={{marginTop : 10}}>
					<Text fz={{md: "lg", lg: "xl"}} className={classes.label}>
						Bu ilə olan məzuniyyət günü : {data?.header?.tillTodayVacDay}
					</Text>
					<Text fz={{md: "lg", lg: "xl"}} className={classes.label}>
						Ötən ildən qalan məzuniyyət günü :
						{data?.header?.otenIldenQalmaQaliq}
					</Text>
					<Text fz={{md: "lg", lg: "xl"}} className={classes.label}>
						İstifadə edilmiş məzuniyyət günü :{data?.header?.usedVacDay}
					</Text>
					<Text fz={{md: "lg", lg: "xl"}} className={classes.label}>
						Cari Qalıq(bu günə olan) :{data?.header?.balanceVacDay}
					</Text>
				</Box>
			</div>
		</Card>
